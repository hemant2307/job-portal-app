...
<section class="section-1 py-5 "> 
    <div class="container">
        <div class="card border-0 shadow p-5">
                    <form action="{{ route('home.job') }}" method="GET">
                    <div class="row">
                        ...
                        <div class="col-md-3 mb-3 mb-sm-3 mb-lg-0">
                            <select name="category" id="category" class="form-control">
                                ...
                                <option value="{{ $newcategory->id }}">{{ $newcategory->category }}</option>
                                @endforeach
                            </select>
                        </div>
        ...
        <div class="row pt-5">
            ...
            <div class="col-lg-4 col-xl-3 col-md-6">
                <div class="single_catagory">
                    <a href="{{ route('home.job').'?category='.$category->id }}"><h4 class="pb-2">{{ $category->category }}</h4></a>
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <p>{{ Str::words($isfeatured->description, 5) }}</p>
                                    <div class="bg-light p-3 border">
                                        ...
                                        <p class="mb-0">
                                            ...
                                            <span class="ps-1">{{ $isfeatured->jobType->job_type }}</span>
                                        </p>
                                        @if ($isfeatured->salary != '')
                                        <p class="mb-0">
                                    ...
                                    <div class="d-grid mt-3">
                                        <a href="{{ route('job.jobdetail',$isfeatured->id) }}" class="btn btn-primary btn-lg">Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="col-md-4">
                            <div class="card border-0 p-3 shadow mb-4">
                                <div class="card-body">
                                    ...
                                    <div class="d-grid mt-3">
                                        <a href="{{ route('job.jobdetail',$latestjob->id) }}" class="btn btn-primary btn-lg">Details</a>
                                    </div>
                                </div>
                            </div>
                        </div>
