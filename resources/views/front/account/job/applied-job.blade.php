                                        ...
                                        <td>
                                            <div class="action-dots float-end">
                                                ...
                                                <ul class="dropdown-menu dropdown-menu-end">
                                                    <li><a class="dropdown-item" href="{{ route('job.jobdetail',$jobApplication->job->id) }}"> <i class="fa fa-eye" aria-hidden="true"></i> View</a></li>
    ...
    if(confirm('are you sure you want to delete this job.?')){
        $.ajax({
            ...
            success:  function(response) { 
                window.location.href = '{{ route("job.appliedJob") }}';
            }
        })
    }
